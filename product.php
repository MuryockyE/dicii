				...
				<div class="row">
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<div>
								<h3 class="product-price">Ksh'.$row['product_price'].'<del class="product-old-price">Ksh990.00</del></h3>
							...
							<ul class="product-links">
								<li>Category:</li>
								<li><a href="body.php">Headphones</a></li>
												...
												<ul class="reviews">
													<li>
														<div class="review-heading">
															<h5 class="name">Eric</h5>
															<p class="date">27 FEB 2024, 8:00 PM</p>

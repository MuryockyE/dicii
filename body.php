  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
	  ...
	  <div class="item">
        <img src="img/banner6.jpg" alt="New York" style="width:100%;">
	  ...
	  <div class="item">
        <img src="img/banner8.jpg" alt="New York" style="width:100%;">
							...
							<div id="get_product_home2">
								...
								<div class="product-widget">
									...
									<div class="product-body">
										...
										<h4 class="product-price">Ksh49999.00 <del class="product-old-price">Ksh990.00</del></h4>
									</div>
								</div>
								<!-- /product widget -->
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
										<h4 class="product-price">Ksh3500.00 <del class="product-old-price">Ksh990.00</del></h4>
									</div>
								</div>
								<!-- /product widget -->
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
										<h4 class="product-price">Ksh980.00 <del class="product-old-price">Ksh990.00</del></h4>
									</div>
								</div>
								<!-- product widget -->
							</div>
